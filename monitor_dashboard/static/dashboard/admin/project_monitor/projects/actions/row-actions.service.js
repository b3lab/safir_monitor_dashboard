...
(function () {
    ...
    angular
        ...
        .factory('horizon.dashboard.admin.project_monitor.projects.actions.rowActions',
            tableRowActions);

    tableRowActions.$inject = [
        '$location',
        'horizon.dashboard.admin.project_monitor.projects.actions.export-metrics',
        'horizon.framework.util.i18n.gettext'
    ];

    /**
     * @ngdoc service
     * @ngname horizon.dashboard.admin.project_monitor.samples.actions.rowActions
     *
     * @description
